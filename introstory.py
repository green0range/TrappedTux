...
i1if="StorylineARCintro.png"
introback1Img = pygame.image.load(i1if).convert_alpha()

i2if="storyline-storm.png"
...
def playintro():
    ...
    if introstory.stage == 1:
        ...
        introtextl1 = "The Antarctica Research Centre (ARC) is the biggest research facility in the world, it attempts to find to way" 
